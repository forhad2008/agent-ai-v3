      ...
      >
        <defs>
          ...
          <radialGradient id="portal_ambient_glow" cx="50%" cy="50%" r="50%">
            ...
            <stop offset="35%" stopColor="#FF204E" stopOpacity="0.35" />
            <stop offset="65%" stopColor="#990000" stopOpacity="0.2" />
            <stop offset="100%" stopColor="#080204" stopOpacity="0" />
          </radialGradient>

          {/* Deep Core Disc Gradient */}
          <radialGradient id="portal_core_grad" cx="45%" cy="40%" r="65%">
            <stop offset="0%" stopColor="#2a0408" />
            <stop offset="45%" stopColor="#1f0206" />
            <stop offset="85%" stopColor="#0f0204" />
          ...
          <linearGradient id="portal_ring_grad1" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <stop offset="30%" stopColor="#FF204E" stopOpacity="0.95" />
            <stop offset="65%" stopColor="#E50914" stopOpacity="0.8" />
            <stop offset="100%" stopColor="#990000" stopOpacity="0.5" />
          </linearGradient>

          {/* Red Ring Gradient 2 */}
          <linearGradient id="portal_ring_grad2" x1="100%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#FF204E" stopOpacity="0.7" />
            <stop offset="40%" stopColor="#E50914" stopOpacity="0.85" />
            <stop offset="80%" stopColor="#990000" stopOpacity="0.9" />
            <stop offset="100%" stopColor="#080204" stopOpacity="0.2" />
          </linearGradient>

          {/* Swirling Outer Energy Arc */}
          <linearGradient id="portal_arc_grad" x1="0%" y1="100%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#990000" stopOpacity="0" />
            <stop offset="30%" stopColor="#E50914" stopOpacity="0.6" />
            <stop offset="70%" stopColor="#FF204E" stopOpacity="0.95" />
            <stop offset="90%" stopColor="#FF4D4D" stopOpacity="0.8" />
...
export const CosmicPlanetArt: React.FC<{ className?: string }> = ({ className = '' }) => {
  return (
    <div className={`relative pointer-events-none select-none overflow-hidden ${className}`}>
      ...
      >
        <defs>
          {/* Crimson & Dark Red Nebula Glow Backdrop */}
          <radialGradient id="bg_nebula_core" cx="80%" cy="50%" r="70%">
            <stop offset="0%" stopColor="#FF204E" stopOpacity="0.45" />
            <stop offset="25%" stopColor="#E50914" stopOpacity="0.65" />
            <stop offset="55%" stopColor="#990000" stopOpacity="0.4" />
            <stop offset="85%" stopColor="#1f0206" stopOpacity="0.15" />
            <stop offset="100%" stopColor="#080204" stopOpacity="0" />
          </radialGradient>

          {/* Glowing Ring Gradient - Red */}
          <linearGradient id="bg_ring_grad1" x1="0%" y1="100%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#FF204E" stopOpacity="0.2" />
            <stop offset="35%" stopColor="#E50914" stopOpacity="0.95" />
            <stop offset="70%" stopColor="#990000" stopOpacity="0.9" />
            <stop offset="100%" stopColor="#2a0408" stopOpacity="0.8" />
          </linearGradient>

          {/* Glowing Ring Gradient 2 */}
          <linearGradient id="bg_ring_grad2" x1="100%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#FF4D4D" stopOpacity="0.9" />
            <stop offset="50%" stopColor="#990000" stopOpacity="0.8" />
            <stop offset="80%" stopColor="#2a0408" stopOpacity="0.4" />
            <stop offset="100%" stopColor="#080204" stopOpacity="0" />
          </linearGradient>
          ...
          <radialGradient id="bg_orb_atmosphere" cx="30%" cy="30%" r="70%">
            ...
            <stop offset="20%" stopColor="#FF204E" stopOpacity="0.85" />
            <stop offset="45%" stopColor="#E50914" stopOpacity="0.75" />
            <stop offset="75%" stopColor="#990000" stopOpacity="0.85" />
            <stop offset="100%" stopColor="#080204" stopOpacity="0.95" />
          </radialGradient>

          {/* 4-Point Flare Star Core Gradient */}
          <radialGradient id="bg_star_core_glow" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stopColor="#FFFFFF" stopOpacity="1" />
            <stop offset="25%" stopColor="#FFCCCC" stopOpacity="0.95" />
            <stop offset="60%" stopColor="#FF204E" stopOpacity="0.8" />
        ...
        {/* 4. Glowing Red Atmospheric Rim Shell */}
        <circle
          cx="480"
          cy="250"
          r="115"
          fill="url(#bg_orb_atmosphere)"
          filter="drop-shadow(0 0 35px rgba(229, 9, 20, 0.8))"
        />

        {/* 5. Electric Red Crescent Limb Highlight */}
        <ellipse
          cx="450"
          cy="240"
          rx="108"
        ...
        <g transform="translate(480, 250)">
          ...
          <circle cx="0" cy="0" r="8" fill="#FFCCCC" />
        </g>
      </svg>
    </div>
  );
      ...
      >
        <defs>
          <linearGradient id="wave_grad_1" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#990000" stopOpacity="0" />
            <stop offset="40%" stopColor="#E50914" stopOpacity="0.8" />
            <stop offset="70%" stopColor="#FF204E" stopOpacity="0.9" />
            <stop offset="100%" stopColor="#2a0408" stopOpacity="0.1" />
          </linearGradient>
          <linearGradient id="wave_grad_2" x1="0%" y1="100%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#2a0408" stopOpacity="0" />
            <stop offset="50%" stopColor="#FF204E" stopOpacity="0.6" />
            <stop offset="100%" stopColor="#E50914" stopOpacity="0" />
          </linearGradient>
        </defs>
        <path
...
export const RadarOrbIcon: React.FC<{ className?: string }> = ({ className = 'h-14 w-14' }) => {
  return (
    <div className={`relative flex items-center justify-center ${className}`}>
      {/* Outer subtle glow */}
      <div className="absolute inset-0 rounded-full bg-[#E50914]/20 blur-md animate-pulse" />
      
      {/* Outer ring */}
      <div className="absolute inset-0 rounded-full border border-[#E50914]/40" />
      
      {/* Middle ring with rotating/pulsing dash */}
      <div className="absolute inset-1.5 rounded-full border border-dashed border-[#FF204E]/50" />
      
      {/* Inner dark circle with red gradient */}
      <div className="relative flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-tr from-[#2a0408] to-[#E50914] shadow-inner shadow-red-900 border border-[#FF204E]/60">
        {/* 4-point star in center */}
        <svg
          viewBox="0 0 24 24"
          className="h-4 w-4 text-white fill-white drop-shadow-[0_0_6px_rgba(255,32,78,0.9)]"
        >
      ...
      >
        <defs>
          ...
          <radialGradient id="luxury_ambient" cx="50%" cy="50%" r="50%">
            ...
            <stop offset="40%" stopColor="#990000" stopOpacity="0.2" />
            <stop offset="70%" stopColor="#1f0206" stopOpacity="0.08" />
            <stop offset="100%" stopColor="#080204" stopOpacity="0" />
          </radialGradient>

          {/* Dark Luxury Glass Red Sphere */}
          <radialGradient id="luxury_sphere_body" cx="35%" cy="30%" r="70%">
            <stop offset="0%" stopColor="#990000" />
            <stop offset="25%" stopColor="#2a0408" />
            <stop offset="55%" stopColor="#1f0206" />
            <stop offset="85%" stopColor="#080204" />
            <stop offset="100%" stopColor="#000000" />
          </radialGradient>

          {/* Metallic Crimson Rim Highlight */}
          <linearGradient id="luxury_rim" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#FF204E" stopOpacity="0.9" />
            <stop offset="35%" stopColor="#E50914" stopOpacity="0.75" />
            <stop offset="70%" stopColor="#990000" stopOpacity="0.4" />
            <stop offset="100%" stopColor="#2a0408" stopOpacity="0.3" />
          </linearGradient>
          ...
          <linearGradient id="luxury_ring_1" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <stop offset="50%" stopColor="#990000" stopOpacity="0.4" />
            <stop offset="100%" stopColor="#2a0408" stopOpacity="0.2" />
          </linearGradient>

          {/* Core Specular Glass Lens Reflection */}
          <linearGradient id="luxury_specular" x1="20%" y1="0%" x2="80%" y2="100%">
            <stop offset="0%" stopColor="#FFFFFF" stopOpacity="0.35" />
            <stop offset="30%" stopColor="#FFCCCC" stopOpacity="0.15" />
            <stop offset="100%" stopColor="#E50914" stopOpacity="0" />
          </linearGradient>
        ...
        <g transform="translate(250, 250)">
          <circle cx="0" cy="0" r="12" fill="#E50914" opacity="0.4" />
          <path
