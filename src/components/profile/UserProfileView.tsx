          ...
          <div className="flex items-center gap-4 sm:gap-5">
            ...
            <div className="relative group shrink-0 flex h-16 w-16 sm:h-20 sm:w-20 items-center justify-center rounded-full p-[3px] bg-gradient-to-r from-[#990000] via-[#E50914] to-[#FF204E] shadow-[0_0_25px_rgba(229,9,20,0.4)] cursor-pointer overflow-hidden">
              <div className="relative flex h-full w-full items-center justify-center rounded-full bg-[#0d0204] overflow-hidden">
                ...
                {/* Hover / Tap overlay */}
                <label className="absolute inset-0 bg-black/80 opacity-0 group-hover:opacity-100 flex flex-col items-center justify-center gap-1 cursor-pointer transition-opacity duration-250">
                  <Camera className="h-5 w-5 sm:h-6 sm:w-6 text-white animate-bounce" />
                  <span className="text-[8px] sm:text-[10px] font-bold text-center px-1 text-white/90">
              ...
              <span className="absolute -bottom-1 -right-1 flex h-5 w-5 items-center justify-center rounded-full bg-[#FF204E] border-2 border-[#080204] text-[10px] text-white font-bold z-10" title="Context Active">
                ✓
              </span>
            </div>
            ...
            <div>
              <div className="flex flex-wrap items-center gap-2 mb-1">
                ...
                <span className="text-[10px] text-[#FF204E] font-semibold flex items-center gap-1">
                  ...
                  {isBangla ? 'ছবি পরিবর্তনের জন্য অ্যাভাতারে ক্লিক করুন' : 'Click avatar to upload picture'}
                </span>
              </div>
        ...
        <div className="lg:col-span-2 space-y-5">
          <form onSubmit={handleSubmit} className="rounded-2xl sm:rounded-3xl border border-[#FF204E]/20 bg-[#0f0306]/95 p-5 sm:p-7 space-y-5 shadow-xl backdrop-blur-xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-semibold text-[#CBD5E1] mb-1.5 flex items-center gap-1.5">
                  <User className="h-3.5 w-3.5 text-[#FF204E]" />
              ...
              <div>
                <label className="block text-xs font-semibold text-[#CBD5E1] mb-1.5 flex items-center gap-1.5">
                  <Briefcase className="h-3.5 w-3.5 text-[#FF204E]" />
              ...
              <div>
                <label className="block text-xs font-semibold text-[#CBD5E1] mb-1.5 flex items-center gap-1.5">
                  <Building className="h-3.5 w-3.5 text-[#FF204E]" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-semibold text-[#CBD5E1] mb-1.5 flex items-center gap-1.5">
                  <Target className="h-3.5 w-3.5 text-[#FF204E]" />
              ...
              <div>
                <label className="block text-xs font-semibold text-[#CBD5E1] mb-1.5 flex items-center gap-1.5">
                  <Code2 className="h-3.5 w-3.5 text-[#FF204E]" />
        ...
        <div className="space-y-5">
          ...
          <div className="rounded-2xl sm:rounded-3xl border border-[#FF204E]/20 bg-[#0f0306]/85 overflow-hidden shadow-xl animate-fadeIn">
            ...
            <div className="px-5 pb-5 relative flex flex-col items-center">
              ...
              <p className="text-xs text-[#FF204E] font-semibold mt-0.5">{userProfile.role}</p>
          ...
          <div className="rounded-2xl sm:rounded-3xl border border-[#FF204E]/30 bg-[#0f0306] p-5 space-y-4 shadow-xl">
            ...
            <div className="pt-2 text-[11px] text-[#94A3B8] flex items-center gap-2">
              <ShieldCheck className="h-4 w-4 text-[#FF204E] shrink-0" />
